...
#         desired_positions = st.text_input("Desired Positions (comma separated)",
#                                           ",".join(st.session_state.candidate.get("desired_positions",[])))
#         location = st.text_input("Current Location", st.session_state.candidate.get("location",""))
#         tech_stack_raw = st.text_area("Tech Stack (comma separated)",
#                                       ",".join(st.session_state.candidate.get("tech_stack_raw",[])))
...
#     # --- Step 1: Basic Info (not inside form yet)
#     name = st.text_input("Full Name", st.session_state.candidate.get("name", ""))
#     email = st.text_input("Email", st.session_state.candidate.get("email", ""))
#     phone = st.text_input("Phone Number", st.session_state.candidate.get("phone", ""))
...
#         "Desired Position(s)",
#         options=job_roles,
#         default=st.session_state.candidate.get("desired_positions", [])
#     )
...
#         fresher_info["college"] = st.text_input("College / University", st.session_state.candidate.get("college", ""))
#         fresher_info["degree"] = st.text_input("Degree / Branch", st.session_state.candidate.get("degree", ""))
...
#         exp_info["current_company"] = st.text_input("Current Company", st.session_state.candidate.get("current_company", ""))
#         exp_info["prev_companies"] = st.text_area(
#             "Previous Companies (Name | Years Worked | Position, separated by commas)",
#             st.session_state.candidate.get("prev_companies", "")
#         )
#         exp_info["notice_period"] = st.selectbox(
#             "Notice Period",
#             ["Immediate", "15 Days", "1 Month", "2 Months", "3 Months+"],
#             index=0
#         )
#         exp_info["expected_ctc"] = st.text_input("Expected CTC (in LPA)", st.session_state.candidate.get("expected_ctc", ""))

#     # --- Step 3: Tech Skills & Other Info ---
#     st.subheader("Technical Skills")
#     tech_stack_raw = st.text_area(
#         "Tech Stack (comma separated)",
#         ",".join(st.session_state.candidate.get("tech_stack", []))
#     )
...
#     certifications = st.text_area("Certifications / Achievements", st.session_state.candidate.get("certifications", ""))
